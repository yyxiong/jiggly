...
(function() {
  var _, basePath, commander, config, configFile, configFilePath, env, envConfig, fs, outerConfig, path, port, ref;
  ...
  if (fs.existsSync(configFile)) {
    ...
    delete config.env;
    if (envConfig = (ref = outerConfig.env) != null ? ref[env] : void 0) {
